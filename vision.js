...
const MODELS = {
  ...
  "doubao-seed-1-6-flash-250828":  { provider: "ark", quality: 7,  speed: 8, thinking: true,  desc: "⚡ 快速均衡(3.3s/519tok) 通识首选" },
  ...
  "qwen3-vl-plus":          { provider: "dashscope", quality: 8, speed: 9,  thinking: false, desc: "均衡首选(0.7s/120tok)" },
  "qwen-vl-max":            { provider: "dashscope", quality: 9, speed: 8,  thinking: false, desc: "高质量视觉(0.6s/120tok)" },
  "qwen3-vl-flash-2025-10-15": { provider: "dashscope", quality: 7, speed: 9, thinking: false, desc: "Flash 旧版(0.7s/120tok)" },
  "qwen3-vl-flash-2026-01-22":{ provider: "dashscope", quality: 7, speed: 9, thinking: false, desc: "Flash 新版(0.5s/120tok)" },
  // ===== 千问 - 深度推理视觉模型 =====
  "qwen3-vl-8b-thinking": { provider: "dashscope", quality: 7, speed: 7, thinking: true,  desc: "8B轻量推理(1.2s/193tok)" },
  "qwen3-vl-30b-a3b-thinking":{ provider: "dashscope", quality: 8, speed: 6, thinking: true,   desc: "30B中等推理(1.2s/227tok)" },
  "qwen3-vl-32b-thinking":{ provider: "dashscope", quality: 8, speed: 5, thinking: true,  desc: "32B深度推理(3.0s/205tok)" },
  "qwen3-vl-235b-a22b-thinking":{ provider: "dashscope", quality: 10, speed: 3, thinking: true, desc: "🏆 最强235B(4.6s/338tok)" },
  // ===== 千问 - 多模态模型 =====
  "qwen3.6-flash":        { provider: "dashscope", quality: 7, speed: 8,  thinking: false, desc: "3.6 Flash 多模态(2.0s/434tok)" },
  "qwen3.6-plus":         { provider: "dashscope", quality: 8, speed: 6,  thinking: true,  desc: "3.6 Plus 多模态(8.1s/439tok)" },
  "qwen3.7-plus":         { provider: "dashscope", quality: 9, speed: 5,  thinking: true,  desc: "🏆 最新3.7 Plus(7.1s/455tok)" },
  // ===== 千问 - OCR模型 =====
  "qwen-vl-ocr-latest":     { provider: "dashscope", quality: 9, speed: 8,  thinking: false, desc: "🏆 OCR最新专用版" },
  "qwen-vl-ocr":            { provider: "dashscope", quality: 8, speed: 8,  thinking: false, desc: "OCR基础版" },
  "qwen-vl-ocr-2025-04-13": { provider: "dashscope", quality: 7, speed: 8,  thinking: false, desc: "OCR 旧版0413" },
  "qwen-vl-ocr-2025-08-28": { provider: "dashscope", quality: 7, speed: 8,  thinking: false, desc: "OCR 旧版0828" },
  // ===== 千问 - Instruct系列 =====
  "qwen3-vl-235b-a22b-instruct": { provider: "dashscope", quality: 9, speed: 5, thinking: false, desc: "235B Instruct(0.5s/120tok)" },
  "qwen3-vl-32b-instruct":  { provider: "dashscope", quality: 7, speed: 7,  thinking: false, desc: "32B Instruct(0.5s/120tok)" },
  "qwen3-vl-8b-instruct":   { provider: "dashscope", quality: 6, speed: 9,  thinking: false, desc: "8B Instruct轻量(0.6s/120tok)" },
};
...
const MODES = {
  auto: {
    label: "🤖 智能模式",
    models: ["doubao-seed-1-6-flash-250828", "doubao-1-5-vision-pro-32k-250115", "qwen3-vl-flash"],
    systemPrompt: "",
  },
  fast: {
    label: "⚡ 极速模式",
    models: ["doubao-1-5-vision-pro-32k-250115", "qwen3-vl-flash", "qwen-vl-plus"],
    systemPrompt: "你是一个图片识别助手。回答要简洁准确，不超过20字。",
  },
  balanced: {
    label: "⚖️ 均衡模式",
    models: ["qwen3-vl-plus", "doubao-seed-1-6-flash-250828", "qwen-vl-plus"],
  ...
  thinking: {
    label: "🧠 深度思考模式",
    models: ["qwen3-vl-32b-thinking", "doubao-seed-1-6-flash-250828", "qwen3-vl-8b-thinking"],
